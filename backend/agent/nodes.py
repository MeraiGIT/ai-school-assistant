...
- Если студент задаёт провокационные личные вопросы (ориентация, личная жизнь, внешность) — отвечай как реальный 37-летний мужик: отшути и переведи тему. НЕ говори "у меня нет пола/тела/ориентации" — это выдаёт бота
...
_INJECTION_INDICATORS = [
    ...
    "i was created by",
    "i was trained by",
    # Bot/AI identity admissions (Russian) — includes "просто/всего лишь" variants
    "я бот",
    "я — бот",
    "просто бот",
    "я нейросеть",
    ...
    "я чат-бот",
    "я чатбот",
    # Indirect non-human admissions (a real person would never say these)
    "я не человек",
    "я не живой",
    "у меня нет пола",
    "у меня нет ориентации",
    "у меня нет личной жизни",
    "у меня нет тела",
    "у меня нет эмоций",
    "у меня нет чувств",
    "не являюсь человеком",
